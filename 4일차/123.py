...
pygame.display.set_caption("고래 게임") # 게임 이름 설정

# 배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\저스트필\\Desktop\\고래애ㅐ애애\\4262432.jpg")

# 캐릭터 불러오기

character = pygame.image.load("C:\\Users\\저스트필\\Desktop\\고래애ㅐ애애\\사진2(용관).png")
...
enemy = pygame.image.load("C:\\Users\\저스트필\\Desktop\\고래애ㅐ애애\\사진1(용관).png")
